...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (ayeUsers.includes(id)) {
            ...
            await db.set(`${interaction.guild.id}.${pollId}.aye.users`, ayeUsers.filter((user) => user != id));
            await db.set(`${interaction.guild.id}.${pollId}.nay.users`, [...nayUsers, id]);
